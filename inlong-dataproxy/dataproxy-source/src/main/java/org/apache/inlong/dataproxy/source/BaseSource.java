...
public abstract class BaseSource
    ...
    public BaseSource() {
        ...
        logger.info("===> create BaseSource");
    }

    @Override
    public synchronized void start() {
        logger.info("===> base source start");
        if (customProcessor) {
    ...
    public void configure(Context context) {
        logger.info("===> base source configure");
        ...
        logger.info("===> context topic = {}, attr = {}", topic, attr);
    ...
    public ChannelInitializer getChannelInitializerFactory() {
        logger.info("===> base source getChannelInitializerFactory");
