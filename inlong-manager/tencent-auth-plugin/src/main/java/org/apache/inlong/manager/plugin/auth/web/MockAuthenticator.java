 ...
 * Mock authenticator
 */
public class MockAuthenticator extends BaseProxyAuthenticator {

    public MockAuthenticator(UserService userService, SmartGateService smartGateService) {
        super(userService, smartGateService);
    }

    @Override
    public String getUserName(AuthenticationToken authenticationToken) {
        return ((MockAuthenticationToken) authenticationToken).getUsername();
    }
